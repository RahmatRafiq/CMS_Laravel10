            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-2">
                        <a href="{{route('master-data.akun-bank.create')}}" type="button" class="btn btn-success waves-effect waves-light">
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap gap-2">
                                            {{-- <a href="{{ route('cms.akun-bank.show', ['id' => $item->id]) }}" type="button" class="btn btn-info waves-effect waves-light btn-sm">
                                                <i class="uil-search"></i> Detail
                                            </a> --}}
                                            <a href="" type="button" class="btn btn-success waves-effect waves-light btn-sm">
                                                <i class="uil-edit"></i> Ubah
                                            </a>
                                            <button type="button" onclick="confirmDelete({{$item->id}})" class="btn btn-danger waves-effect waves-light btn-sm">
