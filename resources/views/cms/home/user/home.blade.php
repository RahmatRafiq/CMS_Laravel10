        ...
        <div class="row">
                ...
                <div class="widget-stat card">
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            ...
                            <div class="media-body">
                                <h3 class="mb-0 text-black"><span class="counter ml-0">{{ number_format($saldo_tripay, 0, ',', '.') }}</span></h3>
            ...
            <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header border-0 pb-0 d-sm-flex d-block">
                        <div>
                            <h4 class="card-title mb-1">Transaski Hari Ini</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-4 mb-4">
                                <div class="border px-3 py-3 rounded-xl">
                                    <h2 class="fs-32 font-w600 counter" id="id_proses"></h2>
                                    <p class="fs-16 mb-0">Proses</p>
                                </div>
                            </div>
                            <div class="col-sm-4 mb-4">
                                <div class="border px-3 py-3 rounded-xl">
                                    <h2 class="fs-32 font-w600 counter" id="id_sukses"></h2>
                                    <p class="fs-16 mb-0">Sukses</p>
                                </div>
                            </div>
                            <div class="col-sm-4 mb-4">
                                <div class="border px-3 py-3 rounded-xl">
                                    <h2 class="fs-32 font-w600 counter" id="id_gagal"></h2>
                                    <p class="fs-16 mb-0">Gagal</p>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive col-sm-12 mb-12">
                            <table class="display">
                                <thead>
                                    <tr>
            ...
            {{-- <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header border-0 pb-0 d-sm-flex d-block">
                        <div>
                            <h4 class="card-title mb-1">Grafik Penjualan</h4>
                            <small class="mb-0">Grafik Penjualan Bangbeli</small>
                        </div>
                    ...
                    <div class="card-body revenue-chart px-3">
                            <div class="d-flex align-items-end pr-3 pull-right revenue-chart-bar">
                                <div class="d-flex align-items-end mr-4">
                                    <img src="{{ asset('cms/images/svg/ic_stat2.svg') }}" height="22" width="22" class="mr-2 mb-1" alt=""/>
                                    <div>
                                ...
                                <div class="d-flex align-items-end">
                                    <img src="{{ asset('cms/images/svg/ic_stat1.svg') }}" height="22" width="22" class="mr-2 mb-1" alt=""/>
                                    <div>
...
@section('javascript')
    ...
    <script>
        ...
        function getSaldo(biller = '',idTag=''){
          ...
          axios.post("{{route('home.saldo')}}",dataPost)
          .then((res)=>{
            let data = res.data
